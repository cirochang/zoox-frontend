   ...
   <section class="content">
      <div class="box box-primary">
         ...
         <div class="box-footer">
           <button type="submit" v-on:click="updateCity()" class="btn btn-primary">Update</button>
         </div>
      </div>
   </section>
...
export default {
    ...
    methods: {
        updateCity() {
            Api.updateCity(this.$route.params.cityId, this.city).then(response => {
                this.$notify({
                    group: 'system',
                    title: `City updated`,
                    text: `The city ${this.city.name} was updated!`
                });
    ...
    beforeMount() {
        ...
        Api.getCity(this.$route.params.cityId).then(response => {
